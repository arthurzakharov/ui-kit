...
export const ControlDropdown = (props: ControlDropdownProps) => {
  ...
  return (
    <div className={clsx(cn.Dropdown, className)}>
      <ControlBox ref={borderRef} onClick={toggleDropdown}>
        <div className={cn.DropdownBorder}>
          <div className={cn.DropdownContent}>
            ...
            <ControlRadioText size="lg" checked oneLine>
      ...
      <ControlBox ref={boxRef} className={isOpen ? cn.DropdownBoxVisible : cn.DropdownBoxHidden}>
            ...
            {visibleChoices.length ? (
              visibleChoices.map(({ value, label }, i) => (
                ...
                >
                  ...
                  <ControlRadioText size="lg" checked={false}>
                    {label}
                  </ControlRadioText>
                </li>
              ))
