...
export const Warranty = ({ title, text, className = '' }: WarrantyProps) => (
  <div data-testid="warranty" className={clsx(css.Warranty, className)}>
    <WarrantyIcon />
    <div className={css.Main}>
      {isHtmlString(text)}
      <Content data-testid="warranty-title" className={css.Title}>
        {title}
      </Content>
      <Content data-testid="warranty-text" className={css.Text}>
        {text}
      </Content>
    </div>
  </div>
